...
!(function (e, r) {
  ...
  return (function (e) {
    ...
    function (e, r, n) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.initWebGL = function (e) {
          var r = [];
          r.push(new f());
          var n = e.getContext("webgl2", t.DRAWING_PARAMS),
            i = !!n;
          i ||
            (n =
              e.getContext("webgl", t.DRAWING_PARAMS) ||
              e.getContext("experimental-webgl", t.DRAWING_PARAMS));
          var o = (function () {
            var e, r, t, o, a;
            i
            ...
            var u = i ? n.HALF_FLOAT : o.HALF_FLOAT_OES;
            n.clearColor(0, 0, 0, 1),
              i
                ? ((e = v(n.RGBA16F, n.RGBA, u)),
                  (r = v(n.RG16F, n.RG, u)),
                  (t = v(n.R16F, n.RED, u)))
                : ((e = v(n.RGBA, n.RGBA, u)),
                  (r = v(n.RGBA, n.RGBA, u)),
            ...
            function v(e, r, t) {
              ...
              n.bindTexture(n.TEXTURE_2D, i),
                ...
                n.texImage2D(n.TEXTURE_2D, 0, e, 4, 4, 0, r, t, null);
              ...
              if (!(a === n.FRAMEBUFFER_COMPLETE))
                switch (e) {
                  case n.R16F:
                    return v(n.RG16F, n.RG, t);
                  case n.RG16F:
                    return v(n.RGBA16F, n.RGBA, t);
                  default:
                    return null;
                }
          ...
          var a = {
            baseVertex: u(n.VERTEX_SHADER, t.SHADER_SOURCE.vertex),
            clear: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.clear),
            color: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.color),
            background: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.background),
            display: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.display),
            displayBloom: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.displayBloom),
            displayShading: u(
              n.FRAGMENT_SHADER,
              t.SHADER_SOURCE.displayShading
            ),
            displayBloomShading: u(
              n.FRAGMENT_SHADER,
            ...
            bloomBlur: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.bloomBlur),
            bloomFinal: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.bloomFinal),
            splat: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.splat),
            advectionManualFiltering: u(
              n.FRAGMENT_SHADER,
              t.SHADER_SOURCE.advectionManualFiltering
            ),
            advection: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.advection),
            divergence: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.divergence),
            curl: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.curl),
            vorticity: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.vorticity),
            pressure: u(n.FRAGMENT_SHADER, t.SHADER_SOURCE.pressure),
            gradientSubtract: u(
              n.FRAGMENT_SHADER,
          ...
          function u(e, r) {
            var t = n.createShader(e);
            if (
              (n.shaderSource(t, r),
              n.compileShader(t),
              !n.getShaderParameter(t, n.COMPILE_STATUS))
            )
              throw n.getShaderInfoLog(t);
            return t;
          }
          return {
            programs:
              ((v = o.supportLinearFiltering),
              {
                clearProgram: new m(a.baseVertex, a.clear, n),
                colorProgram: new m(a.baseVertex, a.color, n),
                backgroundProgram: new m(a.baseVertex, a.background, n),
                displayProgram: new m(a.baseVertex, a.display, n),
                displayBloomProgram: new m(a.baseVertex, a.displayBloom, n),
                displayShadingProgram: new m(a.baseVertex, a.displayShading, n),
                displayBloomShadingProgram: new m(
                  a.baseVertex,
                  a.displayBloomShading,
                  n
                ),
                bloomPreFilterProgram: new m(a.baseVertex, a.bloomPreFilter, n),
                bloomBlurProgram: new m(a.baseVertex, a.bloomBlur, n),
                bloomFinalProgram: new m(a.baseVertex, a.bloomFinal, n),
                splatProgram: new m(a.baseVertex, a.splat, n),
                advectionProgram: new m(
                  a.baseVertex,
                  v ? a.advection : a.advectionManualFiltering,
                  n
                ),
                divergenceProgram: new m(a.baseVertex, a.divergence, n),
                curlProgram: new m(a.baseVertex, a.curl, n),
                vorticityProgram: new m(a.baseVertex, a.vorticity, n),
                pressureProgram: new m(a.baseVertex, a.pressure, n),
        ...
        (r.activator = function (e, r, n, o, a) {
          ...
          (function t() {
            ...
            e.addEventListener("mousemove", function (e) {
              a[0].moved = true; // Ensure moved is always true
          ...
          // Remove the mousedown event listener as it's no longer needed
          ...
          window.addEventListener("mouseup", function () {
            // Keep down property always true
            a[0].down = true;
          });
          ...
          window.addEventListener("keydown", function (e) {
            ...
            if (e.key === " ") {
              E.push(parseInt(20 * Math.random()) + 5);
            }
          });

          // Initialize with down property set to true
          a[0].down = true;
        }),
